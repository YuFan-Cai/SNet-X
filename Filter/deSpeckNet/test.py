...
Save_box = ['./deSpeckNet-Virtual-SAR-A.tiff',
            './deSpeckNet-Virtual-SAR-B.tiff',
            './deSpeckNet-Sentinel-1A.tiff',
            './deSpeckNet-CP-SAR.tiff',
            './deSpeckNet-ERS-1.tiff']
...
if __name__ == '__main__':
    ...
    Model_saved = './Weight/'
    Model = train.deSpeckNet().to("cuda" if torch.cuda.is_available() else "cpu")
