...
%
    ...
    opt1.PET_parameter  = 0.18;    %% Parameter of the Probabilistic Early Termination (=qfuncinv(0.18))
    ...
    opt2.PET_parameter = 0.36;    %% Parameter of the Probabilistic Early Termination (=qfuncinv(0.36))
